  ...
  tasks: [
    {
      ...
      title: 'CS platform',
      description:
        'Игровая платформа для создания лобби и рейтинговой игры в CS2. Альтернатива FACEIT, CYBERSHOKE',
    ...
    },
    {
      ...
      description:
        'Веб-сайт для школы программирования, с возможностью регистрации и просмотра уроков и журнала',
    ...
    },
    {
      ...
      title: 'VaporGram',
      description:
        'Мобильное приложения для текстового и голосового общения в стиле телеграм + свои фишки',
    ...
    },
    {
      ...
      title: 'Event Map',
      description:
        'Карта локальных мероприятий с возможностью добавлять события, звать друзей и строить маршруты',
      status: TaskStatusEnum.DONE,
      stacks: [TechStackEnum.ANGULAR, TechStackEnum.TYPESCRIPT, TechStackEnum.CSS],
      collaborators: [
    ...
    },
    {
      ...
      status: TaskStatusEnum.IN_PROGRESS,
      stacks: [TechStackEnum.NODEJS, TechStackEnum.REACT],
      collaborators: [{ name: 'Олег Миронов', imageUrl: 'https://i.pravatar.cc/150?img=12' }],
    ...
    },
    {
      ...
      stacks: [TechStackEnum.JAVASCRIPT, TechStackEnum.HTML],
      collaborators: [{ name: 'Дарья Волкова', imageUrl: 'https://i.pravatar.cc/150?img=13' }],
    ...
    },
    {
      ...
      stacks: [TechStackEnum.ANGULAR, TechStackEnum.TYPESCRIPT, TechStackEnum.GO],
      collaborators: [],
